...
public class WifiIcons extends SettingsPreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().setTitle(R.string.custom_wifi_bar_title);
    ...
    public class Adapter extends RecyclerView.Adapter<Adapter.CustomViewHolder> {
        ...
        public void onBindViewHolder(CustomViewHolder holder, final int position) {
            ...
            holder.image2.setBackgroundDrawable(getDrawable(holder.image2.getContext(), iconPkg, "ic_wifi_signal_3"));
            holder.image3.setBackgroundDrawable(getDrawable(holder.image3.getContext(), iconPkg, "ic_wifi_signal_2"));
            holder.image4.setBackgroundDrawable(getDrawable(holder.image4.getContext(), iconPkg, "ic_wifi_signal_1"));
