...
import com.colt.enigma.fragments.AmbientService;
...
public final class DozeUtils {
    ...
    private static void startService(Context context) {
        ...
        context.startServiceAsUser(new Intent(context, AmbientService.class),
                UserHandle.CURRENT);
    ...
    private static void stopService(Context context) {
        ...
        context.stopServiceAsUser(new Intent(context, AmbientService.class),
                UserHandle.CURRENT);
    }
