...
import com.colt.settings.bottomnav.ViewUtils;
        ...
        if (attrs != null) {
            ...
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
                    icon = ta.getDrawable(R.styleable.BubbleToggleView_colt_icon);
                else
                    icon = AppCompatResources.getDrawable(getContext(), ta.getResourceId(R.styleable.BubbleToggleView_colt_icon, R.drawable.default_icon));
                iconWidth = ta.getDimension(R.styleable.BubbleToggleView_colt_iconWidth, iconWidth);
                iconHeight = ta.getDimension(R.styleable.BubbleToggleView_colt_iconHeight, iconHeight);
                shape = ta.getDrawable(R.styleable.BubbleToggleView_colt_shape);
                shapeColor = ta.getColor(R.styleable.BubbleToggleView_colt_shapeColor, shapeColor);
                showShapeAlways = ta.getBoolean(R.styleable.BubbleToggleView_colt_showShapeAlways, false);
                title = ta.getString(R.styleable.BubbleToggleView_colt_title);
                titleSize = ta.getDimension(R.styleable.BubbleToggleView_colt_titleSize, titleSize);
                colorActive = ta.getColor(R.styleable.BubbleToggleView_colt_colorActive, colorActive);
                colorInactive = ta.getColor(R.styleable.BubbleToggleView_colt_colorInactive, colorInactive);
                isActive = ta.getBoolean(R.styleable.BubbleToggleView_colt_active, false);
                animationDuration = ta.getInteger(R.styleable.BubbleToggleView_colt_duration, DEFAULT_ANIM_DURATION);
                internalPadding = (int) ta.getDimension(R.styleable.BubbleToggleView_colt_padding, internalPadding);
                titlePadding = (int) ta.getDimension(R.styleable.BubbleToggleView_colt_titlePadding, titlePadding);
            } finally {
                ta.recycle();
            }
        }
